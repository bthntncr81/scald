...
export const AUTH_SIDEBAR: {
  ...
  {
    id: '8286adc5-dfc0-4468-8135-380f987e0823',
    groupTitle: 'Stock Management',
    items: [
      {
        id: '26c7db50-af48-4a63-8dd0-913ab3b3283aca',
        key: 'stock-items',
        title: 'Stock Items',
        href: '/stock-items',
        leftIcon: Bag,
        isActive: (currentPath: string) => currentPath === 'stock-items',
        role: [ROLE.ADMIN, ROLE.MANAGER],
      },
      {
        id: '26c7db50-af48-4a63-8dd0-913ab3b3283acb',
        key: 'recipe',
        title: 'Recipe',
        href: '/recipe',
        leftIcon: Bag,
        isActive: (currentPath: string) => currentPath === 'recipe',
        role: [ROLE.ADMIN, ROLE.MANAGER],
      },
    ],
  },
