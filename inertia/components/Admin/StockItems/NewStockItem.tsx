...
export default function NewStockItem({ refresh }: { refresh: () => void }) {
  ...
  const fieldItems = [
    { name: 'name', label: 'Name', type: 'text', placeholder: 'Stock name' },
    { name: 'unit', label: 'Unit', type: 'text', placeholder: 'gram / adet / dilim' },
          ...
          <Formik
            ...
            onSubmit={async (values: any, actions) => {
              try {
                ...
                const { data } = await axios.post('/api/stock-items', formData, {
                ...
                if (data?.success) {
                  onClose();
                  refresh();
                  toast.success(t(data?.message) || t('Stock item created successfully'));
                }
              } catch (e) {
