...
import { bulkCustomUpdateValidator, bulkDeleteValidator, categoryUpdateValidator, categoryValidator, customUpdateValidator, } from '#validators/category';
...
export default class CategoriesController {
    ...
    async getCategory({ logger, request, response }) {
        try {
