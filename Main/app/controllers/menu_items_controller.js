...
import { bulkDeleteValidator, menuItemValidator, customUpdateValidator, bulkCustomUpdateValidator, menuItemUpdateValidator, } from '#validators/menu_item';
...
export default class MenuItemsController {
    ...
    async exportMenuItems({ logger, request, response }) {
    ...
    async mostPopularItems(limit) {
        ...
        return menuItems.map((menuItem) => {
            const orderCount = popularMenuItems.find((item) => item.menuItemId === menuItem.id)?.$extras.orderCount || 0;
...
//# sourceMappingURL=menu_items_controller.js.map