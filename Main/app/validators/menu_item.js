...
export const menuItemValidator = vine.compile(vine.object({
    categoryId: vine
        .number()
...
export const menuItemUpdateValidator = vine.compile(vine.object({
...
export const bulkDeleteValidator = vine.compile(vine.object({
    ids: vine
        .array(vine.number())
        .distinct()
        .compact()
