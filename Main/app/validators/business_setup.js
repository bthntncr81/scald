...
export const businessInfoValidator = vine.compile(vine.object({
...
export const platformSetupValidator = vine.compile(vine.object({
...
export const siteSettingValidator = vine.compile(vine.object({
    logo: vine
        .file({
        size: '500kb',
